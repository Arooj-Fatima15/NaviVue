...
import MyProfileScreen from '../screens/SettingsScreens/MyProfileScreen'; // Import MyProfileScreen
...
const SettingStackNavigator = () => {
  return (
    <Stack.Navigator initialRouteName="SettingsScreen" screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="NavigationHistory" component={NavigationHistoryScreen} />
